...
| `bdrive capture` | File piped input into `inbox/<date>-<time>.md` in this project — `claude -p "..." \| bdrive capture`. `--share` syncs it and prints a public link. Refuses if the project's scope excludes `inbox/` |
